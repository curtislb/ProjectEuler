...
def next_digit_counts(counts: Matrix[int], num_digits: int) -> Matrix[int]:
    ...
    new_counts = [[0] * 3 for _ in range(9)] # type: Matrix[int]
...
def solve() -> int:
    ...
    counts = [[0] * 3 for _ in range(9)] # type: Matrix[int]
    bouncy_count = 0
